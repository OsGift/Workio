/*
Template: Workio - Responsive Bootstrap 4 Admin Dashboard Template
...
(function (jQuery) {
  ...
  jQuery(document).on("click", ".iq-full-screen", function () {
    ...
    if (
      ...
      !document.WorkioFullscreenElement && // Workio-Browser
      ...
      } else if (document.documentElement.WorkioRequestFullscreen) {
        document.documentElement.WorkioRequestFullscreen(
      ...
      } else if (document.WorkioCancelFullScreen) {
        document.WorkioCancelFullScreen();
